    ...
    <div className="mx-auto px-14 md:max-w-lg lg:max-w-4xl">
      <section className="hero">
        ...
        <div className="justify-start pt-10">
          ...
          <p className="custom-font pt-5">Sudeep Kumar</p>
          <p className="font-dis">
            Software Engineer @ Full Stack
          </p>

          <p className="whytho pt-6 text-gray-600">
            I am a passionate Software Development Engineer with a strong technical background in Javascript, Python, Flask, C/C++, PHP and extensive experience with Typescript, React.js, Next.js, React Native. 
            Welcome to my portfolio, here you will find everything I've done in my professional life.
          </p>

          <div className="flexbox-custom pt-8 md:gap-16">
            <a href="mailto:jdavy7673@gmail.com" className="wahatag">
              <svg
            ...
            <a href="https://github.com/davyj123" className="wahatag">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="ionicon s-ion-icon"
                viewBox="0 0 512 512"
            ...
            <a href="https://www.linkedin.com/in/sudeep-kumar-489207201/" className="wahatag">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="ionicon s-ion-icon"
                viewBox="0 0 512 512"
        ...
        <div className="pt-12">
          ...
          <div className="pt-0">
            <div className="experience-flex">
              ...
              <div className="pt-0">
                ...
                <p className="yewala">Software Developer @ ROSlIBJS</p>
              </div>
              <div>
          ...
          <div className="pt-1">
            <div className="experience-flex">
              ...
              <div className="pt-0">
                <div className='skills-flex'>
                  <h1>Esaathy Digitals Pvt. Ltd.</h1>
